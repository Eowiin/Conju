...
const TENSE_CONTEXTS = {
  ...
  futuro_perfecto: {
    pre: subject => `Para entonces, ${lowerFirst(subject)} ya`,
    tr: text => adaptTranslationTime(text, "fr", "futuro_perfecto"),
    trEn: text => adaptTranslationTime(text, "en", "futuro_perfecto"),
    trPt: text => adaptTranslationTime(text, "pt", "futuro_perfecto"),
  },
  condicional_compuesto: {
    pre: subject => `En ese caso, ${lowerFirst(subject)}`,
    tr: text => adaptTranslationTime(text, "fr", "condicional_compuesto"),
    trEn: text => adaptTranslationTime(text, "en", "condicional_compuesto"),
    trPt: text => adaptTranslationTime(text, "pt", "condicional_compuesto"),
  },
  gerundio: {
    pre: (subject, template) => {
      const estar = {yo:"estoy",tú:"estás",él:"está",nosotros:"estamos",vosotros:"estáis",ellos:"están"};
      return `Ahora, ${lowerFirst(subject)} ${estar[template.pronoun] || "está"}`;
    },
    tr: text => adaptTranslationTime(text, "fr", "gerundio"),
    trEn: text => adaptTranslationTime(text, "en", "gerundio"),
    trPt: text => adaptTranslationTime(text, "pt", "gerundio"),
  },
};
...
function adaptTranslationTime(text, lang, tense) {
  ...
  const prefix = {
    ...
    en: {
      ...
      futuro_perfecto:       "By then, ",
      condicional:           "With more time, ",
      condicional_compuesto: "In that case, ",
    ...
    pt: {
      ...
      futuro_perfecto:       "Até lá, ",
      condicional:           "Com mais tempo, ",
      condicional_compuesto: "Nesse caso, ",
